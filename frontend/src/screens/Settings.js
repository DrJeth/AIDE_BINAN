        ...
        { text: "Cancel", style: "cancel" },
        {
          ...
          onPress: async () => {
            ...
            try {
              ...
              Alert.alert("Success", "Account deleted permanently");
              onClose();
            } catch (error) {
      ...
      <View style={styles.modalContainer}>
        ...
        <View style={styles.modalContent}>
          ...
          {screen === "main" && (
            <>
              <View style={styles.header}>
                <Pressable onPress={onClose} style={styles.backWrap} disabled={loading}>
          ...
          {screen === "email" && (
            <>
              <View style={styles.header}>
                <Pressable onPress={() => setScreen("main")} style={styles.backWrap} disabled={loading}>
                  <Image source={ICON_BACK} style={styles.backIcon} resizeMode="contain" />
                </Pressable>
              ...
              <ScrollView contentContainerStyle={styles.content} scrollEnabled={!loading}>
                ...
                <View style={[styles.card, { marginBottom: 12 }]}>
                  ...
                  {/* <Text style={styles.statusText}>
                    Status: {enabled2FA ? "✓ Enabled" : "✗ Disabled"}
                  </Text> */}
                  {/* <Text style={[styles.statusSubtext, { color: enabled2FA ? "#4CAF50" : "#e8151b" }]}>
                    {enabled2FA ? "Your account is protected" : "Your account is not protected"}
                  </Text> */}
                </View>
                ...
                {/* <View style={styles.card}>
                  {!enabled2FA ? (
                    <>
                      <Text style={styles.screenLabel}>Enter Verification Code</Text>
                      ...
                      >
                        {loading ? (
                          ...
                          <Text style={styles.actionButtonText}>Enable 2FA</Text>
                        )}
                      </TouchableOpacity>
                    </>
                  ) : (
                    <>
                      <View style={styles.successCard}>
                        <Text style={styles.successText}>✓ 2FA is Active</Text>
                        <Text style={styles.successSubtext}>Your account is protected with two-factor authentication</Text>
                      </View>

                      <TouchableOpacity 
                        style={[styles.actionButton, styles.dangerButton, loading && { opacity: 0.5 }]} 
                      ...
                      >
                        {loading ? (
                          ...
                          <Text style={styles.actionButtonText}>Disable 2FA</Text>
                        )}
                      </TouchableOpacity>
                    </>
                  )}
