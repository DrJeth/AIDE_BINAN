...
const handleRejectRider = async () => {
  ...
  const handleSearch = (text) => {
    ...
    const filtered = riders.filter(rider => 
      rider.personalInfo.firstName.toLowerCase().includes(query) ||
      rider.personalInfo.lastName.toLowerCase().includes(query) ||
      rider.ebikeInfo.plateNumber.toLowerCase().includes(query)
    );
